...
func Load() (*DBConfig, error) {
	...
	log.Printf("[PUERTO]: %s", getEnv("DB_PORT", "1526"))
	...
	// go-ora construye la URL con el descriptor TNS completo
	// para compatibilidad con SCAN / RAC
	urlOptions := map[string]string{
		"SERVER": "DEDICATED",
	}
	dsn := go_ora.BuildUrl(host, port, service, user, password, urlOptions)
